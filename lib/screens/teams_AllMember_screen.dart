...
class TeamsAllMemberScreen extends StatefulWidget {
  ...
  @override
  State<TeamsAllMemberScreen> createState() => _TeamsAllMemberScreenState();
}

class _TeamsAllMemberScreenState extends State<TeamsAllMemberScreen>
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextField(
                  decoration: InputDecoration(
                    hintText: 'Reporting Manager Dropdown',
                    //prefixIcon: Icon(Icons.search),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                    ),
